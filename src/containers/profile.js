          ...
          <div className="pr-normal">
            ...
            {this.props.isFetched && (
              <Row>
                <Col span={21}>
                  <div className="title">
                    ...
                    <ul className="statics">
                      ...
                      <li
                        key="LastMonth"
                        title="son 1 ayda girdiği entry sayısı"
                      >
                      ...
                      <li
                        key="Today"
                        title="son 24 saatte girdiği entry sayısı"
                      >
                  ...
                  <div className="meta">
                    ...
                    {this.props.me.info.hasEntryUsedOnSeyler && (
                      <span className="label">
                        <Tag color="#55cbe2">Ekşi Şeyler</Tag>
                      </span>
                    )}

                    {this.props.me.info.banned && (
                      <span className="label">
                ...
                <Col span={3}>
                  <Avatar
                    src={this.props.me.info.picture}
                    size={64}
                    className="pr-avatar"
                  >
